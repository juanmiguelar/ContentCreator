...
JPG defaults to quality 0.95 with a white background. PNG preserves transparency unless the composition draws a background. Await font readiness and image decoding. Keep fonts/images local. Avoid animation, external SVG dependencies and unsupported rendering effects.
