...
const slides = {
  "presencia": {
    "heading": "Tu trabajo merece una presencia digital clara",
    "body": "Una presencia ordenada explica tu valor sin complicar la búsqueda.",
    "tag": "SERVICIO · 01"
  },
  "diseno": {
    "heading": "Diseñamos páginas web para consultorios y profesionales",
    "body": "Con una estructura pensada para presentar lo que haces.",
    "tag": "SERVICIO · 02"
  },
  "esencial": {
    "heading": "Servicios, experiencia, ubicación y contacto en un solo lugar",
    "body": "Haz que encontrarte y contactarte sea más sencillo.",
    "tag": "SERVICIO · 03"
  }
} as const;
const cta = "Solicita una propuesta.";

export default function Post({ format, slideId, metadata, contentStyle }: PostProps) {
  const slide = slides[slideId as keyof typeof slides] ?? slides["presencia"];
